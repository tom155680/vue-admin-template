...
export default {
  ...
  methods: {
    showChart() {
      statistics.getShowData(this.searchObj).then((response) => {
        ...
        dataZoom: [
          {
            ...
            handleIcon:
              "path://M306.1,413c0,2.2-1.8,4-4,4h-59.8c-2.2,0-4-1.8-4-4V200.8c0-" +
              "2.2,1.8-4,4-4h59.8c2.2,0,4,1.8,4,4V413z",
            handleSize: "110%",
            handleStyle: {
              color: "#d3dee5",
            },
