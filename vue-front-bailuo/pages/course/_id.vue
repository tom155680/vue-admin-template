      ...
      <div>
        ...
        <aside class="c-attr-wrap">
          <section class="ml20 mr15">
            ...
            <section v-if=" isbuy || courseWebVo.price === 0" class="c-attr-mt">
              <a
                href="#"
                title="立即观看"
...
export default {
  ...
  methods: {
    //获取课程详情
    getCourseInfo() {
      course.getCourseWebVoInfo(this.courseId).then((response) => {
    ...
    getCommentList() {
      comment
        .getCommentList(this.current, this.pageSize, this.courseId)
        .then((response) => {
    ...
    gotoPage(current) {
      comment
        .getCommentList(current, this.pageSize, this.courseId)
        .then((response) => {
          this.data = response.data.data;
        });
    },
